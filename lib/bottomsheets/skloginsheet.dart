    ...
    try {
      ...
      if (FirebaseAuth.instance.currentUser!.displayName == "users") {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("This email is registered as a customer.")));
        return;
      } else if (FirebaseAuth.instance.currentUser!.displayName ==
          "stationary") {
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
                builder: (context) => StationaryTabs(
                      coltype: FirebaseAuth.instance.currentUser!.displayName
                          .toString(),
                    )),
            (Route route) => false);
      } else if (FirebaseAuth.instance.currentUser!.displayName == "grocery" ||
          FirebaseAuth.instance.currentUser!.displayName == "miscellaneous") {
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
                builder: (context) => groceryandmiscellaneous(
                      coltype: FirebaseAuth.instance.currentUser!.displayName
                          .toString(),
                    )),
            (Route route) => false);
        ...
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
                builder: (context) => ShopkeeperTabs(
                      coltype: FirebaseAuth.instance.currentUser!.displayName
                          .toString(),
                    )),
            (Route route) => false);
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              ...
                              showModalBottomSheet(
                                context: context,
                                builder: (context) => const SkSignupSheet(),
